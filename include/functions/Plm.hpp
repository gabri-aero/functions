...
public:
     ...
     */
    Plm(int l_max, double theta, bool derivatives = false, bool second_derivatives = false) : l_max(l_max), _Nlm(Nlm(l_max)), theta(theta)
    {
        // Allocate ALFs
     ...
     * @param m order
     */
    double get_Plm(int l, int m) { return _Plm[lm_idx(l, m)] / _Nlm.get_Nlm(l, m); };
     ...
     * @param m order
     */
    double get_dPlm(int l, int m) { return _dPlm[lm_idx(l, m)] / _Nlm.get_Nlm(l, m); };
     ...
     * @param m order
     */
    double get_ddPlm(int l, int m) { return _ddPlm[lm_idx(l, m)] / _Nlm.get_Nlm(l, m); };
